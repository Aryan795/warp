...
impl From<TeamVisibility> for GqlTeamVisibility {
    fn from(visibility: TeamVisibility) -> Self {
        match visibility {
            TeamVisibility::Open => GqlTeamVisibility::Open,
            TeamVisibility::Private => GqlTeamVisibility::Private,
            TeamVisibility::Hidden => GqlTeamVisibility::Hidden,
        }
    }
}
