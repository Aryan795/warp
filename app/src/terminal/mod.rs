...
pub use history::{
    History, HistoryEntry, HistoryEvent, ShellHost, TuiHistorySuggestion, UpArrowHistoryConfig,
    history_suggestions_for_terminal_view, prompt_history_for_terminal_view,
};
