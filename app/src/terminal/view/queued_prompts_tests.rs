        ...
        terminal.update(&mut app, |view, ctx| {
            ...
            view.ambient_agent_view_model()
                ...
                .update(ctx, |model, ctx| {
                    model.spawn_agent_with_request(cloud_spawn_request("write tests"), None, ctx);
                });
    ...
    App::test((), |mut app| async move {
        ...
        terminal.update(&mut app, |view, ctx| {
            ...
            view.ambient_agent_view_model()
                .expect("cloud terminal should have an ambient model")
                .update(ctx, |model, ctx| {
                    model.spawn_agent_with_request(cloud_spawn_request("initial"), None, ctx);
                });
    ...
    App::test((), |mut app| async move {
        ...
        let conversation_id = terminal.update(&mut app, |view, ctx| {
            ...
            view.ambient_agent_view_model()
                .expect("cloud terminal should have an ambient model")
                .update(ctx, |model, ctx| {
                    model.spawn_agent_with_request(promptless_cloud_spawn_request(), None, ctx);
                });
            QueuedQueryModel::handle(ctx).update(ctx, |model, ctx| {
                model.append(
                    conversation_id,
